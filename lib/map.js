(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('echarts/lib/chart/map'), require('echarts/lib/echarts'), require('echarts/lib/component/tooltip'), require('echarts/lib/component/legend')) :
  typeof define === 'function' && define.amd ? define(['exports', 'echarts/lib/chart/map', 'echarts/lib/echarts', 'echarts/lib/component/tooltip', 'echarts/lib/component/legend'], factory) :
  (global = global || self, factory(global.eMap = {}, null, global.echarts));
}(this, function (exports, map$1, echartsLib) { 'use strict';
  ...
  var map = function map(columns, rows, settings, extra) {
    var _settings$position = settings.position,
        position = _settings$position === void 0 ? 'china' : _settings$position,
    ...
    var registerOptions = {
      ...
      registerSign: "MAP_REGISTER_".concat(position),
      registerSignOnce: "ONCE_MAP_REGISTER_".concat(position),
      position: position,
