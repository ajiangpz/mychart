(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('echarts/lib/chart/bar'), require('echarts/lib/echarts'), require('echarts/lib/component/tooltip'), require('echarts/lib/component/legend')) :
  typeof define === 'function' && define.amd ? define(['exports', 'echarts/lib/chart/bar', 'echarts/lib/echarts', 'echarts/lib/component/tooltip', 'echarts/lib/component/legend'], factory) :
  (global = global || self, factory(global.eBar = {}, null, global.echarts));
}(this, function (exports, bar, echartsLib) { 'use strict';
  ...
  function get(target, path, defaultValue) {
    ...
    var pathArr = path.split ? path.split('.') : [path];
    var targetTemp = target;
